IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'pc_ins_refund'))
begin
  PRINT 'Dropping...pc_ins_refund'
  DROP PROCEDURE pc_ins_refund
end
PRINT 'Creating...pc_ins_refund'
GO

create procedure pc_ins_refund
(
...
begin transaction 
	begin try 
		...
		set @pkid = IDENT_CURRENT('dbo.Refund')
		select @pkid
	end try
begin catch
...
PRINT 'Creating...pc_ins_refund...complete'
go